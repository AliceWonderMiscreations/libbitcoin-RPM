...
%if 0%{?rhel}
%define vendoroption --with-vendor="Alice Wonder Miscreations"
...
Release:        1%{?libo_prerelease}%{?dist}.2
...
%changelog
* Mon Feb 27 2017 Alice Wonder <buildmaster@librelamp.com> - 1:5.3.1.1-1.2
- Rebuild for CentOS 7, building against newer boost than CentOS 7
-  has, as well as some dependencies updated from rawhide (f26)
-  and some dependencies from rawhide not in CentOS 7
- Build with newer libicu
- Changed vendor string to Alice Wonder Miscreations
