...
%description -n compat-cppzmq-devel
...
mv %{buildroot}%{_bindir}/curve_keygen %{buildroot}%{_bindir}/curve_keygen-%{version}
rm -f %{buildroot}%{_libdir}/libzmq.so.5
...
%files -n compat-cppzmq-devel
%license cppzmq-LICENSE
%{_includedir}/zmq.hpp
