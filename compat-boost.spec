...
Requires: compat-boost-atomic%{?_isa} = %{version}-%{release}
Requires: compat-boost-chrono%{?_isa} = %{version}-%{release}
Requires: compat-boost-container%{?_isa} = %{version}-%{release}
%if %{with context}
Requires: compat-boost-context%{?_isa} = %{version}-%{release}
Requires: compat-boost-coroutine%{?_isa} = %{version}-%{release}
%endif
Requires: compat-boost-date-time%{?_isa} = %{version}-%{release}
Requires: compat-boost-filesystem%{?_isa} = %{version}-%{release}
Requires: compat-boost-graph%{?_isa} = %{version}-%{release}
Requires: compat-boost-iostreams%{?_isa} = %{version}-%{release}
Requires: compat-boost-locale%{?_isa} = %{version}-%{release}
Requires: compat-boost-log%{?_isa} = %{version}-%{release}
Requires: compat-boost-math%{?_isa} = %{version}-%{release}
Requires: compat-boost-program-options%{?_isa} = %{version}-%{release}
Requires: compat-boost-python%{?_isa} = %{version}-%{release}
Requires: compat-boost-random%{?_isa} = %{version}-%{release}
Requires: compat-boost-regex%{?_isa} = %{version}-%{release}
Requires: compat-boost-serialization%{?_isa} = %{version}-%{release}
Requires: compat-boost-signals%{?_isa} = %{version}-%{release}
Requires: compat-boost-system%{?_isa} = %{version}-%{release}
Requires: compat-boost-test%{?_isa} = %{version}-%{release}
Requires: compat-boost-thread%{?_isa} = %{version}-%{release}
Requires: compat-boost-timer%{?_isa} = %{version}-%{release}
Requires: compat-boost-wave%{?_isa} = %{version}-%{release}
...
%endif
%if 0%{?rhel}
BuildRequires: compat-libicu-devel
%else
...
Patch64: boost-1.58.0-no-rpath.patch
...
Group: System Environment/Libraries
Requires: compat-boost-python3%{?_isa} = %{version}-%{release}
Requires: compat-boost-devel%{?_isa} = %{version}-%{release}
...
Requires: compat-boost%{?_isa} = %{version}-%{release}
Provides: compat-boost-python-devel = %{version}-%{release}
...
BuildArch: noarch
%endif
Requires: compat-boost-devel = %{version}-%{release}
...
Group: System Environment/Libraries
Requires: compat-boost-devel%{?_isa} = %{version}-%{release}
Requires: compat-boost-openmpi%{?_isa} = %{version}-%{release}
Requires: compat-boost-openmpi-python%{?_isa} = %{version}-%{release}
Requires: compat-boost-graph-openmpi%{?_isa} = %{version}-%{release}
...
Group: System Environment/Libraries
Requires: compat-boost-devel%{?_isa} = %{version}-%{release}
Requires: compat-boost-mpich%{?_isa} = %{version}-%{release}
Requires: compat-boost-mpich-python%{?_isa} = %{version}-%{release}
Requires: compat-boost-graph-mpich%{?_isa} = %{version}-%{release}
...
%if !%{with context}
    	--without-context --without-coroutine --without-coroutine2 --without-fiber \
%endif
...
%{_libdir}/libboost_container-mt.so.%{sonamever}
...
-  added container sub-package
-  added coroutine sub-package (disabled when context not available)
-  added log sub-package
- Renamed package to compat-boost for parallel install w/ vendor boost
