...
%if 0%{?rhel}
Requires: compat-libicu-devel%{?_isa}
%else
...
%changelog
* Mon Feb 27 2017 Alice Wonder <buildmaster@librelamp.com> - 1.63.0-4.1
- Build against newer libicu

* Fri Feb 24 2017 Alice Wonder <buildmaster@librelamp.com> - 1.63.0-4.0
- Build for CentOS 7
