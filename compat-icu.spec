...
%package  -n compat-libicu-devel
Summary:  Development files for International Components for Unicode
Group:    Development/Libraries
Requires: compat-libicu%{?_isa} = %{version}-%{release}
Requires: pkgconfig

%description -n compat-libicu-devel
...
* Fri Nov 18 2016 Eike Rathke <erack@redhat.com> - 56.1-7
- dist.rpmgrill: "Percent signs in specfile changelog should be escaped"

* Fri Nov 18 2016 Eike Rathke <erack@redhat.com> - 56.1-6
- Resolves: rhbz#1377362 CVE-2016-7415

* Tue Nov 01 2016 Eike Rathke <erack@redhat.com> - 56.1-5
- Resolves: rhbz#1360340 CVE-2016-6293

* Tue Apr 05 2016 Eike Rathke <erack@redhat.com> - 56.1-4
- rhbz#1307633 FTBFS, reenable the checks
